...
> Technical specification derived from PRD FR-001–FR-012 and verified against
> commit `bfcd92b`. Identifiers are English; user-facing messages are Polish.
...
- Cross-layer happy path: `e2e/concept-review.spec.ts`.
