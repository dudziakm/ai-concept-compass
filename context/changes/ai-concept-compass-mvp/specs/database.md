...
> Source of truth: `supabase/migrations/20260731190000_ai_concept_compass.sql`
> at commit `bfcd92b`. This document explains intent; SQL remains authoritative.
...
`tests/rls.integration.test.ts` is the executable two-account proof for
...
retained CI evidence remain pending credentials; the presence of the harness is
not presented as a passing RLS proof.
