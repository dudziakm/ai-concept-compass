...
6. Również greenfield wymagał osobnej poprawki CI po pierwszym commicie MVP (`bfcd92b`: wygenerowanie typów Astro przed lintem). To jeden przypadek, nie trend, ale potwierdza koszt późnego wykrycia driftu środowiska.
