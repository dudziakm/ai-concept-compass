...
Po merge infrastruktury reviewera do `master`:
...
4. W ruleset/branch protection dla `master` włącz wymagany status check **AI Code Review Gate** dopiero po pierwszym poprawnym runie, gdy GitHub zna nazwę checka.
